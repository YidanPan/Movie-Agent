...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            modelscope_timeout_seconds=min(600, max(10, int(os.getenv("MODELSCOPE_TIMEOUT_SECONDS", "240")))),
            modelscope_max_retries=min(5, max(1, int(os.getenv("MODELSCOPE_MAX_RETRIES", "2")))),
            modelscope_max_tokens=min(32768, max(1024, int(os.getenv("MODELSCOPE_MAX_TOKENS", "8192")))),
