...
def asset_record(
    ...
    *,
    ...
    renderer_contract_status: str = "",
    renderer_verification_status: str = "",
    ...
    return {
        **metadata,
        ...
        "generation_input_hash": str(generation_input_hash or ""),
        "provider_request_fingerprint": str(provider_request_fingerprint or ""),
        ...
        "compiled_prompt_digest": str(compiled_prompt_digest or ""),
        "derived_seed": int(derived_seed) if derived_seed is not None else (int(seed) if seed is not None else None),
        "source_duration_seconds": int(source_duration_seconds) if source_duration_seconds is not None else None,
        "renderer_manifest_version": str(renderer_manifest_version or ""),
        "renderer_contract_status": str(renderer_contract_status or ""),
        "renderer_verification_status": str(renderer_verification_status or ""),
